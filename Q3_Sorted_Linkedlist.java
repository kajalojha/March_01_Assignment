...
public class Q3_Sorted_Linkedlist {
    ...
    public static void main(String[] args) {
        Q3_Sorted_Linkedlist  solution = new Q3_Sorted_Linkedlist (); // Create an instance of the solution class
